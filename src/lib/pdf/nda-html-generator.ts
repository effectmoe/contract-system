    ...
    return `
      <div class="contract-terms">
        ...
        <div class="term-item">
          ...
          <div class="term-content">
            <p>1. 本契約において秘密情報とは、直接・間接的であるかを問わず、本目的のために開示される情報をいう。なお、情報開示の方法は、書面、口頭その他方法を問わず、乙から甲に開示された、乙の営業上、技術上その他業務上の一切の情報をいい（以下、例示情報を示すがこれに限られるものではない）、本契約書発行後に限らず、本契約日以前に提供された情報も含む。</p>
            <div class="sub-items">
              <p>(1) 甲の事業に関わる、ソフトウェア、サービス、知的財産権、技術、サンプル、レポート、その他資料、顧客（潜在顧客も含む）、事業計画、サプライヤー、販促活動、金融情報</p>
              <p>(2) (1)の外、秘密であると分類されたもの、あるいは秘密であると甲が認識しているもの、または秘密であると合理的に推認されるもの</p>
